...
controllers.controller('CreateKeyController', ['$scope', 'Keys', '$state', '$location', 'Notification', function($scope, Keys, $state, $location, Notification){
...
controllers.controller('DeleteKeyController', ['$state', '$scope', 'Key', '$location', 'Notification', function($state, $scope, Key, $location, Notification){
...
controllers.controller('UpdateKeyController', ['$state', '$scope', 'Key', 'Keys', '$location', 'Notification', function($state, $scope, Key, Keys, $location, Notification){
